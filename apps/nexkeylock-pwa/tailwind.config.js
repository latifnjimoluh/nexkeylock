/** Système de design NexKeyLock (mêmes jetons que l'app de bureau). */
...
export default {
  ...
  theme: {
    extend: {
      ...
      borderRadius: { jeton: "0.625rem" },
      boxShadow: { panneau: "0 1px 2px rgb(0 0 0 / 0.06), 0 8px 24px rgb(0 0 0 / 0.08)" },
      fontFamily: {
